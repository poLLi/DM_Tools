    ...
    <section class="full-height">
        <b-container>
            <div class="line line-middle">
                <div class="line-dot dot-top"></div>
                <div class="line-dot dot-bottom"></div>
            </div>

            <div class="headline">
                <h2 class="title text-primary">Privacy</h2>
                <p class="desc">The usual stuff here.</p>
            </div>
            ...
            <div class="info">
                ...
                <p>
                    ...
                    E-Mail: justlook.network[at]gmail.com
                </p>
                <p>
                ...
                <p>
                    ...
                    seiner Dienste. Sofern eine entsprechende Einwilligung abgefragt wurde (z. B. eine Einwilligung zur
                    Speicherung von Cookies), erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1
